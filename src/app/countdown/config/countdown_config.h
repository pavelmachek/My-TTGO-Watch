 ...
 */
#ifndef _COUNTDOWN_CLOCK_CONFIG_H
    #define _COUNTDOWN_CLOCK_CONFIG_H
     ...
     */
    class countdown_properties_t : public BaseJsonConfig {
        public:
        countdown_properties_t();
        bool beep;
        bool fade;
        bool vibe;
...
#endif // _COUNTDOWN_CLOCK_CONFIG_H
